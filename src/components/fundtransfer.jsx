...
class FundTransfer extends React.Component {
  ...
  validateName = (sourceMobileNo) =>
    sourceMobileNo
      ...
      : sourceMobileNo.length < 10
      ? " Must Contain 10 Character"
      : "";

  validateName = (targetMobileNo) =>
    !targetMobileNo
      ? "Number Must Be Entered"
      : targetMobileNo.length < 10
      ? " Must Contain 10 Character"
      : "";
      ...
      <div>
        ...
        <form className="w-50 mx-auto border p-3" onSubmit={this.handleSubmit}>
          <div className="mb-3">
            ...
            />
            {errors.sourceMobileNo ? (
              <span className="text-danger">{errors.sourceMobileNo}</span>
            ) : (
              ""
            )}
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {errors.targetMobileNo ? (
              <span className="text-danger">{errors.targetMobileNo}</span>
            ) : (
              ""
            )}
          </div>
